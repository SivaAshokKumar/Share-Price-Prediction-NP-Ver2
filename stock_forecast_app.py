...
# Main Header
st.title("📈 NeuralProphet Stock Forecasting")
...
if predict_button:
    ...
    fig.update_layout(
        title=f"NeuralProphet Rolling Forecast - {ticker.upper()}",
        xaxis_title="Date",
        yaxis_title="Price",
        height=600
    )
    ...
    st.info("👈 Enter the stock ticker and date range, then click 'Predict' to start.")
